...
{
    public class WeChatPublicAuthenticationHandler : OAuthHandler<WeChatPublicAuthenticationOptions>
    {
        public WeChatPublicAuthenticationHandler(
            [NotNull] IOptionsMonitor<WeChatPublicAuthenticationOptions> options,
